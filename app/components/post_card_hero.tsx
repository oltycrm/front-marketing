...
export default function PostCardHero({ post }: any) {
  return (
    <div>
      <Link to={`${post.slug}`}>
        <a
          className="bg-white  flex flex-col md:flex-row sm:items-center rounded-lg  p-3.5  
           max-w-5xl mx-auto bg-slate-40  ring-offset-4 hover:ring-2 ring-blue-500
          object-cover object-center transition transition-opacity duration-1000"
        >
